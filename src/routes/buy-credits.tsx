...
const PACKS = [
  {
    ...
    credits: 10,
    perCredit: "$0.80",
    features: ["10 AI room generations", "Real buyable product tags", "Google Visual Search", "Great for testing a few rooms"],
    cta: "Buy 10 Credits",
    hot: false,
  ...
  },
  {
    ...
    credits: 30,
    perCredit: "$0.70",
    features: ["30 AI room generations", "Real buyable product tags", "Google Visual Search", "Best price per credit — enough for a full home refresh"],
    cta: "Buy 30 Credits",
    hot: true,
    tag: "Most Popular",
  },
  {
    ...
    credits: 65,
    perCredit: "$0.69",
    features: ["65 AI room generations", "Real buyable product tags", "Google Visual Search", "Lowest cost per credit — for serious redesigners"],
    cta: "Buy 65 Credits",
    hot: false,
    tag: "Best Value",
  },
